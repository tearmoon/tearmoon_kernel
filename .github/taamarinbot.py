...
KSUV = os.environ.get("KSUV")
SUBVER = os.environ.get("SUBVER")
COMMIT = os.environ.get("COMMIT")

MSG_TEMPLATE = """
{version} Linux v4.14.{subver}

️WARNING!!!
— for personal use
— I m not responsible if your Phone explodes

Commit:
— KernelSU version: {ksuv}
{commit}

#A11 #R #KERNEL #KSU #GINKGO
""".strip()
